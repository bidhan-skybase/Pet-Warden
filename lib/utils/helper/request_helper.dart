...
class PetRequest {
  static Future<http.Response> post(String url,
    ...
    try {
      ...
      LogHelper.info("Post Request Header ==> $url", error: json.encode(headers));
  ...
  static Future<http.StreamedResponse> multiPart({
    ...
    try {
      ...
      http.MultipartRequest request = http.MultipartRequest(type, Uri.parse(url));
